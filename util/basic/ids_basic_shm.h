#ifndef _IDS_BASIC_SHM_H_
#define _IDS_BASIC_SHM_H_
...
#define GetShm3(pstShm,iKey,iSize,iFlag) 	OI_GetShm3(pstShm,iKey,iSize,iFlag)
     ...
     * @return NULL 表示失败 
     */
    char *OI_GetShm(int iKey, size_t iSize, int iFlag);
     ...
     * @return NULL 表示失败 
     */
    char *OI_GetShmOnlyMat(int iKey, size_t *piSize, int iFlag);
     ...
     * @return  <0 表示失败
     */
    int OI_GetShm2(void **pstShm, int iKey, size_t iSize, int iFlag);
     ...
     */
    int OI_GetShm3(void **pstShm, int iKey, size_t iSize, int iFlag);


    char *OI_GetShm4(int iKey, size_t iSize, int iFlag, int *piShmID);
